  ...
  return (
    <header className="bg-slate-600 h-14 text-white text-sm">
      ...
      <ul className="list-none h-full flex flex-row items-center p-2 justify-end">
        <li className=" mr-2 rounded-md hover:bg-white hover:bg-opacity-25 p-1 duration-700 flex">
        ...
        <li className=" mr-2 rounded-md hover:bg-white hover:bg-opacity-25 p-1 duration-700">
          <NavLink to="/map" className="flex items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
        ...
        <li className=" mr-2 rounded-md hover:bg-white hover:bg-opacity-25 p-1 duration-700">
          <NavLink to="/mixes" className="flex items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
